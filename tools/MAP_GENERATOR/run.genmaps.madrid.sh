...
python genmaps.bastra.py -c gmp.madrid_las_tablas.rand2.conf
python genmaps.bastra.py -c gmp.madrid_las_tablas.uni5.conf
...
python genmaps.bastra.py -c gmp.madrid_barrio_salamanca.uni5.conf
